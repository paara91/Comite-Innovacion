...
3. Clic en **"New app"** → selecciona el repositorio que acabas de crear →
   en "Main file path" pon `streamlit_app/app.py` (sin espacios en el
   nombre de la carpeta — con espacio, Streamlit Cloud no encuentra el
   `requirements.txt` y falla el despliegue) → **Deploy**.
